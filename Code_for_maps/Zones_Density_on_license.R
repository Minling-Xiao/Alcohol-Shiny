...
ShaperDenOn = st_read('Shapefiles/shaper/ShaperDenOn/ShaperDenOn.shp')
st_geometry(density_for_on_license_with_geom) = ShaperDenOn$geometry
st_crs(density_for_on_license_with_geom) = crs
Density = density_for_on_license_with_geom
...
save(map, file = "map/on_license_pop_density.RData")
...
# save(map, file = "map/on_license_area_density.RData")
