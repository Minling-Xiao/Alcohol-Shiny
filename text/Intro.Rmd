...
When visualizing the density of alcohol outlets for each quintile of deprivation level, the values of Extremal Quotient (max density / min density) and Relative Risk (Quintile 5 density / Q1 density) are reported on the graphs.
